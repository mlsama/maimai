        	...
        	if(rows.length == 0){
        		...
        		$("#itemEditWindow").window({
            		onLoad : function(){
            			...
            			/** 加载商品描述 */
            			$.getJSON('/item/itemdesc/' + data.id, function(data){
            				/** 在富文本编辑器中显示数据 */
        ...
        handler : function(){
        	...
        	if(rows.length == 0){
        		...
        		$.messager.confirm('确认','确定下架ID为 '+ids+' 的商品吗？',function(r){
            	    if (r){
                    	$.post("/item/instockOrReshelf",{"ids" : ids.join(","),"option":"down"}, function(){
        ...
        handler : function(){
        	...
        	if(rows.length == 0){
        		...
        		$.messager.confirm('确认','确定上架ID为 '+ids+' 的商品吗？',function(r){
            	    if (r){
                    	$.post("/item/instockOrReshelf", {"ids" : ids.join(","),"option":"up"} , function(data){
